...
PARAFLAG  = -DMPI  -DOMP
MATHFLAG  = -DUSESCALAPACK -DUNPACKED -DUSEFFTW3 -DHDF5 -DOMP_TARGET -DOPENACC -DUSEELPA -DUSEELPA_GPU # -DUSEPRIMME # -DUSEELPA # USEELPA_GPU
...
ELPALIB=${ELPA_ROOT}/lib/libelpa.a ${CUDALIB} -lstdc++
