...
HIP_INC = -I${HIPFORT_ROOT}/include/hipfort/amdgcn -I${ROCM_PATH}/include
#HIP_INC = -J/ccs/home/mdelben/frontier_BGW/LOCAL_libs/hipfort/build/include/hipfort/amdgcn/ -I${ROCM_PATH}/include/
HIP_LIB = ${HIPFORT_ROOT}/lib/libhipfort-amdgcn.a -L${ROCM_PATH}/lib -lamdhip64  -lhipfft -lhipblas
