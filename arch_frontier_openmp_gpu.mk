...
# 2023, ORNL
#
# By default on AMD GPUs and Cray compiler the OpenACC programming model will be used for the offloading, you can switch to OpenMP-target
# using the corresponding input flags of just recompile without OpenACC support using this arch.mk file.
# 
...
PARAFLAG  = -DMPI  -DOMP
MATHFLAG  = -DUSESCALAPACK -DUNPACKED -DUSEFFTW3 -DHDF5 -DOMP_TARGET -DHIP_API # -DUSEPRIMME
#
...
F90free = ftn -f free -homp -g -ef -hacc_model=auto_async_none:no_fast_addr:no_deep_copy  ${HIP_INC} ${HIP_LIB} # -hlist=a -fopenmp
LINK    = ftn -f free -homp -g -ef -hacc_model=auto_async_none:no_fast_addr:no_deep_copy  ${HIP_INC} ${HIP_LIB} # -fopenmp
FOPTS   = -O1  # -fast 
FNOOPTS = $(FOPTS)
#MOD_OPT =  -J
MOD_OPT = -J 
